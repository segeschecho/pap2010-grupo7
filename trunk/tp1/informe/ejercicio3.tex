...
La primer linea de cada caso de test contiene una cadena X de una longitud no mayor a 10000, compuesta enteramente de caracteres del alfabeto en minúscula. La segunda línea contiene otra cadena Z de longitud no mayor a 100, y también compuesta solamente de caracteres del alfabeto en minúscula. Se asegura que ni Z ni ningun prefijo o sufijo del mismo tendrá más de 10100 distintas ocurrencias en X como subsecuencia.
